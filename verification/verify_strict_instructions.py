...
def verify_strict_output_instructions():
    with sync_playwright() as p:
        ...
        # Now, expect another dropdown (simple-sub-category-2)
        ...
        # Verify it contains the new strict instructions
        target_phrase = "IMPORTANT OUTPUT RULE"
        if target_phrase in final_prompt:
            print("SUCCESS: Strict instructions found in prompt.")
        else:
            print("FAILURE: Strict instructions NOT found in prompt.")

        # Take screenshot
        page.screenshot(path="verification/strict_instructions_verification.png")

        browser.close()

if __name__ == "__main__":
    verify_strict_output_instructions()
