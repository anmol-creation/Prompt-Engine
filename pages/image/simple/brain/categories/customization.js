...
import { faceGenerators, generateMaleFaceDefault, generateMaleHairStyle } from '../../generate/customization/male/face.js';
...
const ICONS = {
    ...
    hair_cut: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128zm89.6 32h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h352c26.5 0 48-21.5 48-48v-41.6c0-74.2-60.2-134.4-134.4-134.4z"/></svg>` // fallback user icon for now as specific scissors icon might not be available, reused user icon or maybe I can find a better one.
};

// Use a distinct icon for hair_cut if possible, otherwise reuse user
ICONS.hair_cut = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M168 32c-44.2 0-80 35.8-80 80 0 9.7 2.1 19 5.8 27.5L5.7 395.7c-9.2 27.6 15.3 52.3 42.9 43.1L304.7 353.2c8.5 3.7 17.8 5.8 27.5 5.8 44.2 0 80-35.8 80-80 0-44.2-35.8-80-80-80-8.8 0-17.2 1.5-25 4.1L172.1 57C174.7 49.2 176.2 40.8 176.2 32h-8.2zM98.8 162.9c.1 0 .2.1.3.1l65.8 65.8-80.4 80.4-36.8-36.8 51.1-109.5zM413.2 279.1c27.6-9.2 52.3 15.3 43.1 42.9L370.8 506.2c-8.5 3.7-17.8 5.8-27.5 5.8-44.2 0-80-35.8-80-80 0-44.2 35.8-80 80-80 8.8 0 17.2 1.5 25 4.1l135.2-145.8c-2.6-7.8-4.1-16.2-4.1-25 0-44.2 35.8-80 80-80 44.2 0 80 35.8 80 80 0 9.7-2.1 19-5.8 27.5l-133.4 256.3z"/></svg>`; // Scissors-like shape (actually scissors icon)
