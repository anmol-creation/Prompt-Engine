// Category Data for Creative Image
import * as Generators from '../generators/creative-image.js';

export const creativeImageCategory = {
    type: 'group',
    options: {
        "Movies": {
            type: "group",
        ...
        "Toons": {
            ...
            options: {
                ...
                "The Lion King": { type: "static", prompt: "Transform the subject into the The Lion King animation style. Adjust clothing, environment, lighting, and visual style to match that world. Preserve subject identity and image quality." }
            }
        },
        "Universe": {
            type: "group",
            enableType: true,
            searchPlaceholder: "Type universe name...",
        ...
        "Mythology": {
            type: "group",
            enableType: true,
            searchPlaceholder: "Type mythology name...",
        ...
        "Role": {
             type: "group",
             enableType: true,
             searchPlaceholder: "Type universe for role...",
             customGenerator: Generators.roleGenerator,
             options: {
                 "Marvel Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type Marvel hero...",
                 ...
                 "DC Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type DC hero...",
                 ...
                 "Star Wars Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type Star Wars character...",
                 ...
                 "Harry Potter Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type Harry Potter character...",
                 ...
                 "Lord of the Rings Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type LotR character...",
                 ...
                 "Game of Thrones Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type GoT character...",
                 ...
                 "Assassin’s Creed Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type Assassin...",
                 ...
                 "Mortal Kombat Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type fighter...",
                 ...
                 "Cyberpunk Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type cyberpunk character...",
                 ...
                 "God of War Universe": {
                     type: "group",
                     enableType: true,
                     searchPlaceholder: "Type God of War character...",
        ...
        "History": {
             type: "group",
             enableType: true,
             searchPlaceholder: "Type historical figure...",
