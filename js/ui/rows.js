...
import { BLUR_DEFAULT_SETTINGS, REMOVE_DEFAULT_SETTINGS, REPLACE_DEFAULT_SETTINGS, TRANSPARENT_DEFAULT_SETTINGS, STUDIO_DEFAULT_SETTINGS } from '../data/uiMeta.js';
...
export function setupRow(rowElement) {
    ...
    actionSelect.addEventListener('change', () => {
        ...
        if (act) {
            ...
            if (cat === 'Background' && (act === 'Blur' || act === 'Remove' || act === 'Replace' || act === 'Transparent' || act === 'Studio')) {
...
export function updateAllRowsForMode() {
    ...
    rows.forEach(row => {
         ...
         if (catSelect.value === 'Background' && (actSelect.value === 'Blur' || actSelect.value === 'Remove' || actSelect.value === 'Replace' || actSelect.value === 'Transparent' || actSelect.value === 'Studio')) {
             // Force update row UI
