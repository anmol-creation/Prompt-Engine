    ...
    createBtn.addEventListener('click', () => {
        ...
        rows.forEach(row => {
            ...
            if (cat && act) {
                ...
                if (currentMode === 'default' && cat === 'Background' && (act === 'Blur' || act === 'Remove' || act === 'Replace' || act === 'Gradient' || act === 'Extend' || act === 'Outdoor' || act === 'Shadow Adjust' || act === 'Transparent' || act === 'Studio')) {
